                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: toggleVisibility ? IconButton( icon:  Icon(Icons.visibility_outlined)  , onPressed: (){
                                setState(() {
                                  toggleVisibility = false;
                                });
                              }, color: Color(0xff737373)) : IconButton( icon:  Icon(Icons.visibility_off_outlined)  , onPressed: (){
                                setState(() {
