...
class _AccountPageState extends State<AccountPage> {
 ...
 @override
 void initState() {
   Provider.of<MainState>(context, listen: false).GetUserChildDetails(context);
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          childDetails.isEmpty ? CircularProgressIndicator() :
                          Expanded(
                            child: Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                           children: [
                             childDetails.isEmpty ? CircularProgressIndicator() :   ListView.builder(

                               shrinkWrap : true,
                               itemCount:  Provider.of<MainState>(context, listen: false).childDetails.length,
                                 itemBuilder: (context, index) {
                                 return    Text(
                                   childDetails[index]['firstName'] + '||' ,
                                   style: TextStyle(
                            ...
                            GestureDetector(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  ...
                                  value.GetUserChildDetails(context);
                                      value.GetUserDetails(context);
                                     },
                                child: Container(
                                  height: 40,
                                  width: 150,
